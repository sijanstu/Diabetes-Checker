...
def predict_disease(pregnancies, glucose, bp, skin, insulin, bmi, func, age):
    import pickle
    import numpy as np
    model = pickle.load(open('svm_model.pkl', 'rb'))
    scaler = pickle.load(open('scaler.pkl', 'rb'))
    input_features = [[pregnancies, glucose, bp, skin, insulin, bmi, func, age]]
...
predict_disease(5, 166, 72, 19, 175, 25.8, 0.587, 51)
